...
use Zend\UserModule\Form\ChangeEmailFilter as Filter;
...
class ChangeEmailFilterTest extends \PHPUnit_Framework_TestCase
{
    public function testConstruct()
    {
        ...
        $validator = $this->getMockBuilder('Zend\UserModule\Validator\NoRecordExists')->disableOriginalConstructor()->getMock();
