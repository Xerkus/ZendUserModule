...
use Zend\UserModule\Form\Register as Form;
...
class RegisterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $options = $this->getMock('Zend\UserModule\Options\RegistrationOptionsInterface');
    ...
    public function testSetGetRegistrationOptions()
    {
        ...
        $optionsNew = $this->getMock('Zend\UserModule\Options\RegistrationOptionsInterface');
