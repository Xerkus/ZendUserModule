...
class RedirectCallbackTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->moduleOptions = $this->getMockBuilder('Zend\UserModule\Options\ModuleOptions')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testInvoke()
    {
        ...
        $this->router->expects($this->any())
            ->method('assemble')
            ->with(array(), array('name' => 'zenduser'))
    ...
    public function testGetRedirectRouteFromRequest($get, $post, $getRouteExists, $postRouteExists)
    {
        ...
        $method = new \ReflectionMethod(
            'Zend\UserModule\Controller\RedirectCallback',
    ...
    {
        return array(
            array('zenduser/login', 'zenduser', '/user', 'getLoginRedirectRoute'),
            array('zenduser/authenticate', 'zenduser', '/user', 'getLoginRedirectRoute'),
            array('zenduser/logout', 'zenduser/login', '/user/login', 'getLogoutRedirectRoute'),
            array('testDefault', 'zenduser', '/home', false),
        );
    }

    public function testGetRedirectWithOptionOnButNoRedirect()
    {
        $route = 'zenduser/login';
        $redirect = false;
