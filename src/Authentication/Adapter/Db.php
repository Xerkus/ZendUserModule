...
use Zend\UserModule\Authentication\Adapter\AdapterChainEvent as AuthEvent;
use Zend\UserModule\Mapper\User as UserMapperInterface;
...
class Db extends AbstractAdapter
{
    ...
    {
        if (null === $this->mapper) {
            $this->mapper = $this->getServiceManager()->get('zenduser_user_mapper');
        }
        return $this->mapper;
    }
