...
namespace Zend\UserModule\Service;
...
use Zend\Hydrator;
use Zend\UserModule\EventManager\EventProvider;
use Zend\UserModule\Mapper\UserInterface as UserMapperInterface;
use Zend\UserModule\Options\UserServiceOptionsInterface;
...
class User extends EventProvider
{
    ...
    public function register(array $data)
    {
        ...
        $user = $form->getData();
        /* @var $user \Zend\UserModule\Entity\UserInterface */
    ...
    public function getUserMapper()
    {
        if (null === $this->userMapper) {
            $this->userMapper = $this->getServiceManager()->get('zenduser_user_mapper');
        }
    ...
    public function getAuthService()
    {
        if (null === $this->authService) {
            $this->authService = $this->getServiceManager()->get('zenduser_auth_service');
        }
    ...
    public function getRegisterForm()
    {
        if (null === $this->registerForm) {
            $this->registerForm = $this->getServiceManager()->get('zenduser_register_form');
        }
    ...
    public function getChangePasswordForm()
    {
        if (null === $this->changePasswordForm) {
            $this->changePasswordForm = $this->getServiceManager()->get('zenduser_change_password_form');
        }
    ...
    public function getOptions()
    {
        if (!$this->options instanceof UserServiceOptionsInterface) {
            $this->setOptions($this->getServiceManager()->get('zenduser_module_options'));
        }
        return $this->options;
    }
    ...
    public function getFormHydrator()
    {
        if (!$this->formHydrator instanceof Hydrator\HydratorInterface) {
            $this->setFormHydrator($this->getServiceManager()->get('zenduser_register_form_hydrator'));
        }
