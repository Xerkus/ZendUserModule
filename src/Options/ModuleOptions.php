    ...
    UserServiceOptionsInterface
{
     ...
     * @var string
     */
    protected $loginRedirectRoute = 'zenduser';

    /**
     * @var string
     */
    protected $logoutRedirectRoute = 'zenduser/login';
     ...
     * @var array
     */
    protected $authAdapters = array( 100 => 'Zend\UserModule\Authentication\Adapter\Db' );
     ...
     * @var string
     */
    protected $userEntityClass = 'Zend\UserModule\Entity\User';

    /**
     * @var string
     */
    protected $userLoginWidgetViewTemplate = 'zend-user/user/login.phtml';
